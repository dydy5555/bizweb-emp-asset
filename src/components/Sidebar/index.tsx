      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <Image
            width={300}
            height={50}
            src={"/images/logo/em-logo-white.svg"}
            alt="Logo"
            priority
          />
        </Link>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 hover:rounded-xl ${
                   (!pathname.includes("setting") && !pathname.includes("tables") && !pathname.includes("profile") ) && "bg-graydark rounded-xl dark:bg-meta-4"
                  }`}
                >
                  <svg
                          className="fill-current"
              ...
              <li>
                <Link
                  href="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 hover:rounded-xl ${
                    pathname.includes("profile") && "bg-graydark rounded-xl dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  href="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 hover:rounded-xl ${
                    pathname.includes("tables") && "bg-graydark rounded-xl dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 hover:rounded-xl ${
                    ...
                    "bg-graydark rounded-xl dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
